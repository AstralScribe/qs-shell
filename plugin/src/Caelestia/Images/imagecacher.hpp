...
public:
  ...
  void schedule(const QString& sourcePath, const QString& cachePath, const QSize& size,
                FillMode fillMode);

private:
  explicit ImageCacher(QObject* parent = nullptr);

  static void runJob(const QString& sourcePath, const QString& cachePath, const QSize& size,
                     FillMode fillMode);
