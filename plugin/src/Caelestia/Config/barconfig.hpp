...
public:
  explicit BarScrollActions(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
public:
  explicit BarPopouts(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
public:
  explicit BarWorkspaces(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
public:
  explicit BarActiveWindow(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
public:
  explicit BarTray(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
public:
  explicit BarStatus(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
public:
  explicit BarClock(QObject* parent = nullptr) : ConfigObject(parent) { }
};
