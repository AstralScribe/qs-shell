...
class Tokens : public QQuickAttachedPropertyPropagator, public QQmlParserStatus {
  ...
  Q_PROPERTY(
      const caelestia::config::AppearanceRounding* rounding READ rounding NOTIFY sourceChanged)
  ...
  Q_PROPERTY(const caelestia::config::AppearanceTransparency* transparency READ transparency NOTIFY
                 sourceChanged)
