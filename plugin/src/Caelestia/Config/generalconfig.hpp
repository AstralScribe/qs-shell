...
public:
  explicit GeneralApps(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
public:
  explicit GeneralIdle(QObject* parent = nullptr) : ConfigObject(parent) { }
};
  ...
  CONFIG_GLOBAL_PROPERTY(QVariantList, warnLevels,
                         {
                             ...
                             vmap({
                                 ...
                                 {u"message"_s,
                                  u"You should probably plug in a charger <b>now</b>"_s},
...
public:
  explicit GeneralBattery(QObject* parent = nullptr) : ConfigObject(parent) { }
};
