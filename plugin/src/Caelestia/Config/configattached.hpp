...
class Config : public QQuickAttachedPropertyPropagator, public QQmlParserStatus {
  ...
  Q_PROPERTY(
      const caelestia::config::AppearanceConfig* appearance READ appearance NOTIFY sourceChanged)
  Q_PROPERTY(const caelestia::config::GeneralConfig* general READ general NOTIFY sourceChanged)
  Q_PROPERTY(
      const caelestia::config::BackgroundConfig* background READ background NOTIFY sourceChanged)
  ...
  Q_PROPERTY(
      const caelestia::config::DashboardConfig* dashboard READ dashboard NOTIFY sourceChanged)
  ...
  Q_PROPERTY(
      const caelestia::config::UtilitiesConfig* utilities READ utilities NOTIFY sourceChanged)
