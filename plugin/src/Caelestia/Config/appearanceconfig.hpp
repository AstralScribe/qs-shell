...
public:
  explicit AppearanceRounding(QObject* parent = nullptr) : ConfigObject(parent) { }
...
public:
  explicit AppearanceSpacing(QObject* parent = nullptr) : ConfigObject(parent) { }
...
public:
  explicit AppearancePadding(QObject* parent = nullptr) : ConfigObject(parent) { }
...
public:
  explicit FontConfig(QObject* parent = nullptr) : ConfigObject(parent) { }
...
public:
  explicit IconFontStyleConfig(QObject* parent = nullptr)
      : FontStyleConfig(parent), m_extraLarge(new FontConfig(this)) { }
};
...
public:
  explicit AppearanceAnim(QObject* parent = nullptr)
      : ConfigObject(parent), m_durations(new AnimDurations(this)) { }
};
...
public:
  explicit AppearanceTransparency(QObject* parent = nullptr) : ConfigObject(parent) { }
};
