...
class AnimTokens : public QObject {
  ...
  Q_PROPERTY(
      QEasingCurve expressiveDefaultSpatial READ expressiveDefaultSpatial NOTIFY curvesChanged)
  ...
  Q_PROPERTY(
      QEasingCurve expressiveDefaultEffects READ expressiveDefaultEffects NOTIFY curvesChanged)
