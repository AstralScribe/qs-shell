...
public:
  explicit RoundingTokens(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
public:
  explicit SpacingTokens(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
public:
  explicit PaddingTokens(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
public:
  explicit AnimDurationTokens(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
public:
  explicit DashboardTokens(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
public:
  explicit LauncherTokens(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
public:
  explicit NotifsTokens(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
public:
  explicit OsdTokens(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
public:
  explicit SessionTokens(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
public:
  explicit SidebarTokens(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
public:
  explicit UtilitiesTokens(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
public:
  explicit LockTokens(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
public:
  explicit WInfoTokens(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
public:
  explicit NexusTokens(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
private:
  ...
  explicit TokenConfig(TokenConfig* fallback, const QString& filePath, const QString& screen = {},
