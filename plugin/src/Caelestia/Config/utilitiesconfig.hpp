...
public:
  explicit UtilitiesToasts(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
public:
  explicit UtilitiesVpn(QObject* parent = nullptr) : ConfigObject(parent) { }
};
...
public:
  explicit UtilitiesConfig(QObject* parent = nullptr)
      : ConfigObject(parent), m_toasts(new UtilitiesToasts(this)), m_vpn(new UtilitiesVpn(this)) { }
};
