...
TickingService::TickingService(QObject* parent) : Service(parent), m_timer(new QTimer(this)) {
  ...
  QObject::connect(dash, &caelestia::config::DashboardConfig::resourceUpdateIntervalChanged, this,
                   [this, dash] { applyInterval(dash->resourceUpdateInterval()); });
}

int TickingService::updateInterval() const { return m_interval; }
