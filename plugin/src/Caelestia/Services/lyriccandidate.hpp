...
public:
  enum Backend { Auto = 0, Local, LRCLIB, NetEase };
  Q_ENUM(Backend)
...
public:
  ...
  LyricCandidate(LyricsBackend::Backend backend, QString id, QString title, QString artist,
                 QString album = {}, qreal duration = 0.0);
