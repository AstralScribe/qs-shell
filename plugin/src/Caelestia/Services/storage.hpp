...
class Storage : public TickingService {
  ...
  Q_PROPERTY(
      QQmlListProperty<caelestia::services::DiskInfo> disks READ disksProp NOTIFY disksChanged)
  Q_PROPERTY(caelestia::services::DiskInfo* manualPrimaryDisk READ manualPrimaryDisk WRITE
                 setManualPrimaryDisk NOTIFY manualPrimaryDiskChanged)
