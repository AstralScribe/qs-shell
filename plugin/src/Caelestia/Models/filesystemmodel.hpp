...
public:
  explicit FileSystemEntry(const QString& path, const QString& relativePath,
...
class FileSystemModel : public QAbstractListModel {
  ...
  Q_PROPERTY(QQmlListProperty<caelestia::models::FileSystemEntry> entries READ entries NOTIFY
                 entriesChanged)
