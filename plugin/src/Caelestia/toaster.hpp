...
public:
  ...
  explicit Toast(const QString& title, const QString& message, const QString& icon, Type type,
                 int timeout, QObject* parent = nullptr);
...
public:
  ...
  Q_INVOKABLE void toast(const QString& title, const QString& message,
