...
struct BlobRectData {
  ...
  // Bitmask of indices in this rect's m_cachedRects that mutually exclude (or are excluded by) this
  // rect. Used by the shader to skip smin between excluded pairs.
  int excludeMask = 0;
};
